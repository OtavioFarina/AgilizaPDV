...
try {
  $estabelecimentos = $conn->query("SELECT * FROM estabelecimento ORDER BY nome_estabelecimento")->fetchAll(PDO::FETCH_ASSOC);
} catch (Exception $e) {
  $estabelecimentos = [];
}
  ...
  <div class="top-bar">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end shadow border-0">
        <li><a class="dropdown-item py-2" href="cad_usuario.php"><i class='bx bx-arrow-back'></i> Voltar</a></li>
