                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="sabor"
                            value="<?= htmlspecialchars($dados['sabor']) ?>" required>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="id_categoria" required>
                            <?php foreach ($categorias as $cat): ?>
                                <option value="<?= $cat['id_categoria'] ?>"
                                    <?= ($dados['id_categoria'] == $cat['id_categoria']) ? 'selected' : '' ?>>
                        ...
                        <select class="form-select" name="id_fornecedor" required>
                            <?php foreach ($fornecedores as $forn): ?>
                                <option value="<?= $forn['id_fornecedor'] ?>"
                                    <?= ($dados['id_fornecedor'] == $forn['id_fornecedor']) ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="preco_venda"
                            value="<?= htmlspecialchars($dados['preco_venda']) ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Compra (R$)</label>
                        <input type="text" class="form-control" name="preco_compra"
                            value="<?= htmlspecialchars($dados['preco_compra']) ?>" required>
                    </div>
