...
try {
  ...
  if (isset($_GET['ex'])) {
    ...
    if ($id != $_SESSION['id_usuario']) {
      $conn->prepare("UPDATE usuarios SET ativo = 0 WHERE id_usuario = ?")->execute([$id]);
...
<body>
  ...
  <div class="main-container">
    ...
    <?php
    $sql = "SELECT u.id_usuario, u.nome_usuario, u.tipo_usuario, e.nome_estabelecimento FROM usuarios u LEFT JOIN estabelecimento e ON u.id_estabelecimento = e.id_estabelecimento WHERE u.ativo = 1";
